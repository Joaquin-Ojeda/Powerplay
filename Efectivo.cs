...
namespace TPFinal
{
    public partial class Efectivo : Form
    {
        ...
        Usuario usuario;
        double total;
        public Efectivo(Carrito carrito, Usuario usuario)
        {
            InitializeComponent();
        ...
        public void validarDatos()
        {
            ...
            if (int.Parse(textPostal.Text) <= 0 || long.Parse(textTelefono.Text) <= 0)
            {
                throw new Exception();
            }
        }
        ...
        //Funcion para cargar el carrito en el pdf
        public void cargarDatos(Document pdfDoc, iTextSharp.text.Font subTitulo)
        {
